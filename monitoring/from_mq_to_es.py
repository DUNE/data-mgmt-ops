...
class ElasticConn():
  def __init__(self, host_port, auth):
    ...
    #self.__es1 = es.Elasticsearch(hosts=[{'host': 'tatties.ph.ed.ac.uk', 'port':9200}], http_auth=('xxxx','xxxx'), timeout=200, max_retries=5, retry_on_timeout=True)
    self.__index_type = []
